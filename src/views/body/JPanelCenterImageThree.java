...
public class JPanelCenterImageThree extends JPanel{
	
	private static final long serialVersionUID = 1L;

	public JPanelCenterImageThree() {
	...
	private void addImageThree() {
		
		JLabel imageCenterPanel = new JLabel();
		imageCenterPanel.setIcon(new ImageIcon(getClass().getResource(ConstantsGUI.BODY_IMAGE_THREE)));
		imageCenterPanel.setBorder(BorderFactory.createMatteBorder(20, 20, 0, 20, Color.WHITE));
		add(imageCenterPanel);
				
		JLabel titleCenterPanel = new JLabel(ConstantsGUI.TITLE_THIRD_IMAGE);
		titleCenterPanel.setFont(new Font("Garage Gothic Bd", Font.BOLD, 20));
		titleCenterPanel.setBorder(BorderFactory.createMatteBorder(20, 100, 20, 20, Color.WHITE));
		add(titleCenterPanel);
		
		JLabel textCenterPanel = new JLabel(ConstantsGUI.TEXT_THIRD_IMAGE);
